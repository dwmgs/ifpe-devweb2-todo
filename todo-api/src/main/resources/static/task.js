...
function salvarDados() {
    ...
    fetch(`http://52.90.166.42:8080/api/user/findById?id=${idUser}`, {
        method: "GET",
        headers: {
        ...
        .then(savedUser => {
            ...
            return fetch("http://52.90.166.42:8080/api/card/save", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
function carregarTasks() {
    fetch("http://52.90.166.42:8080/api/card/findAll")
